...
import VendorPop from './VendorPop';
...
export const Manage_Vendors = (props) => {
  ...
  return (
    ...
    <div className="row page-titles mx-0">
      ...
      <NavLink to="/Vendor">Vendors</NavLink>
      </li>
      <li className="breadcrumb-item active">
      <NavLink to="/ManageVendors">Vendor detail</NavLink>
      </li>
    </ol>
          <PageHeader
              title="Vendor Detais"
              subTitle="Details of all the Vendors"
